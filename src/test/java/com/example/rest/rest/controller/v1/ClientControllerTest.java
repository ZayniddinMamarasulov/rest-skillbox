...
public class ClientControllerTest extends AbstractTestController {
    ...
    public void whenFindAll_thenReturnAllClients() throws Exception {
        ...
        String exceptedResponse = StringTestUtils.readStringFromResource("response/find_all_clients_response.json");
        ...
        JsonAssert.assertJsonEquals(exceptedResponse, actualResponse);
    }
    ...
    public void whenFindByIdNotExistedClient_thenReturnError() throws Exception {
        Mockito.when(clientService.findById(500L)).thenThrow(new EntityNotFoundException("Client with ID 500 was not found"));
        ...
        String expectedResource = StringTestUtils.readStringFromResource("response/client_by_id_not_found_response.json");

        Mockito.verify(clientService, Mockito.times(1)).findById(500L);

        JsonAssert.assertJsonEquals(expectedResource, actualResponse);
    }
